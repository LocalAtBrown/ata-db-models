...
class Event(SQLModel, table=True):
    ...
    unstruct_event_com_snowplowanalytics_snowplow_change_form_1: Union[list, dict] = Field(sa_column=Column(JSON))
    ...
    # TODO probably optional and json
    unstruct_event_com_snowplowanalytics_snowplow_focus_form_1: Union[list, dict] = Field(sa_column=Column(JSON))
    ...
    # TODO probably optional and json
    unstruct_event_com_snowplowanalytics_snowplow_submit_form_1: Union[list, dict] = Field(sa_column=Column(JSON))
    # Raw useragent
    useragent: str
